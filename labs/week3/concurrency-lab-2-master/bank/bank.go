...
func (bank *bank) lockAccount(accountNumber int, lockedBy string) bool {
...
func (bank *bank) unlockAccount(accountNumber int, lockedBy string) bool {
	account := bank.accounts[accountNumber]
	if lockedBy != account.lockedBy {
		return false
	}
